...
public class PersistComponentsStepTest extends BaseStepTest {
  ...
  public void setup() throws Exception {
    ...
    sut = new PersistComponentsStep(dbClient, computeComponentsRefCache, persistedComponentsRefCache);
  }
  ...
  public void persist_components() throws Exception {
    ...
    assertThat(persistedComponentsRefCache.getByRef(1).getId()).isEqualTo(project.getId());
    assertThat(persistedComponentsRefCache.getByRef(2).getId()).isEqualTo(module.getId());
    assertThat(persistedComponentsRefCache.getByRef(3).getId()).isEqualTo(directory.getId());
    assertThat(persistedComponentsRefCache.getByRef(4).getId()).isEqualTo(file.getId());
  }
