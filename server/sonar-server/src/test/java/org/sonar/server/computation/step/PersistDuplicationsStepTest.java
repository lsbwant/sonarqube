...
import org.sonar.server.computation.component.PersistedComponentsRefCache.PersistedComponent;
...
public class PersistDuplicationsStepTest extends BaseStepTest {
  ...
  PersistedComponentsRefCache persistedComponentsRefCache;
  ...
  public void setup() throws Exception {
    ...
    persistedComponentsRefCache = new PersistedComponentsRefCache();
    sut = new PersistDuplicationsStep(dbClient, persistedComponentsRefCache);
  }
  ...
  public void persist_duplications_on_same_file_linked_on_a_module() throws Exception {
    persistedComponentsRefCache.addComponent(1, new PersistedComponent(1L, "PROJECT_KEY", "ABCD"));
    persistedComponentsRefCache.addComponent(2, new PersistedComponent(2L, "MODULE_KEY", "BCDE"));
    persistedComponentsRefCache.addComponent(3, new PersistedComponent(3L, "MODULE_KEY:file", "CDEF"));
  ...
  public void persist_duplications_on_same_file_linked_on_a_folder() {
    persistedComponentsRefCache.addComponent(1, new PersistedComponent(1L, "PROJECT_KEY", "ABCD"));
    persistedComponentsRefCache.addComponent(2, new PersistedComponent(2L, "PROJECT_KEY:dir", "BCDE"));
    persistedComponentsRefCache.addComponent(3, new PersistedComponent(3L, "PROJECT_KEY:file", "CDEF"));
  ...
  public void persist_duplications_on_same_file_linked_on_sub_folder() {
    persistedComponentsRefCache.addComponent(1, new PersistedComponent(1L, "PROJECT_KEY", "ABCD"));
    persistedComponentsRefCache.addComponent(2, new PersistedComponent(2L, "PROJECT_KEY:dir", "BCDE"));
    persistedComponentsRefCache.addComponent(3, new PersistedComponent(3L, "PROJECT_KEY:dir", "CDEF"));
    persistedComponentsRefCache.addComponent(10, new PersistedComponent(10L, "PROJECT_KEY:file", "DEFG"));
  ...
  public void persist_duplications_on_different_files() {
    persistedComponentsRefCache.addComponent(3, new PersistedComponent(3L, "PROJECT_KEY:file2", "CDEF"));
    saveDuplicationMetric();
    BatchReportWriter writer = initReportWithProjectAndFile();
  ...
  private BatchReportWriter initReportWithProjectAndFile() {
    persistedComponentsRefCache.addComponent(1, new PersistedComponent(1L, "PROJECT_KEY", "ABCD"));
    persistedComponentsRefCache.addComponent(2, new PersistedComponent(2L, "PROJECT_KEY:file", "BCDE"));
