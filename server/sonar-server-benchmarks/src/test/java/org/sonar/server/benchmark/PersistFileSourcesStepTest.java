...
public class PersistFileSourcesStepTest {
  ...
  PersistedComponentsRefCache persistedComponentsRefCache = new PersistedComponentsRefCache();
  ...
  private void persistFileSources(File reportDir) {
    ...
    PersistFileSourcesStep step = new PersistFileSourcesStep(dbClient, System2.INSTANCE, persistedComponentsRefCache);
  ...
  private File prepareReport() throws IOException {
    ...
    persistedComponentsRefCache.addComponent(1, new PersistedComponent(1L, "PROJECT", PROJECT_UUID));
  ...
  private void generateFileReport(BatchReportWriter writer, int fileRef) throws IOException {
    ...
    persistedComponentsRefCache.addComponent(fileRef, new PersistedComponent((long)fileRef, "PROJECT:"+fileRef, Uuids.create()));
